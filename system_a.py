#This script is for System A construction.
...
if __name__ == "__main__":
    ...
    english_train_dataset = prepare_dataset(english_train_set, tokeniser, label_to_id)
    print("number of english training:", len(english_train_dataset))
